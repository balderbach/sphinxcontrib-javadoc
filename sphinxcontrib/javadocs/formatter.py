...
def output_declaration(declaration, output):
    ...
    if (
        isinstance(declaration, javalang.tree.InterfaceDeclaration)
        and declaration.extends
    ):
        output.append(" extends ")
    ...
    if (
        isinstance(
            declaration, (javalang.tree.ClassDeclaration, javalang.tree.EnumDeclaration)
        )
        and declaration.implements
    ):
