...
import sphinxcontrib.javadoc.compiler as compiler
...
def generate_documents(source_files, cache_dir, verbose, member_headers, parser):
    ...
    for source_file in source_files:
        ...
        this_file_documents = generate_from_source_file(
            doc_compiler, source_file, cache_dir
        )
...
Note: By default this script will not overwrite already created files."""
    ...
    parser.add_option(
        "-f", "--force", action="store_true", dest="force", help="Overwrite all files"
    )
    parser.add_option(
        "-c",
        "--cache-dir",
    ...
    parser.add_option(
        ...
        action="store_true",
        dest="update",
        help="Overwrite new and changed files",
        default=False,
    )
    parser.add_option(
        "-T",
    ...
    parser.add_option(
        ...
        action="append",
        dest="includes",
        help="Additional input paths to scan",
        default=[],
    )
    parser.add_option(
        "-p",
    ...
    packages, documents, sources = generate_documents(
        source_files, opts.cache_dir, opts.verbose, opts.member_headers, opts.parser_lib
    )
